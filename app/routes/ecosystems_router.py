...
async def read(ecosystem_id: int, _: Annotated[UserModel, Depends(get_current_user), None],
               db: Annotated[Session, Depends(get_db)]) -> EcosystemModel:
...
async def update(ecosystem_id: int, ecosystem: EcosystemModel, _: Annotated[UserModel, Depends(get_current_user), None],
...
async def delete(ecosystem_id: int, _: Annotated[UserModel, Depends(get_current_user), None],
                 db: Annotated[Session, Depends(get_db)]) -> None:
